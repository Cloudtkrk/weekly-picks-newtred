...
| 日付 (UTC) | 対象データ | 備考 |
|---|---|---|
| 2026-09-10 | 2026-09-07 分 (売れ筋48件 / 新商品39件) | TYMO取り下げ・とちぎの星追加を反映 |
| 2026-09-24 | 2026-09-24 分 (売れ筋50件 / 新商品78件) | 初のKalodata画面取得データ(CSV)。カテゴリ誤り4件を補正 |
| 2026-09-24 | 2026-09-24 分 (再公開) | 商品画像の修正を反映。[no-discord] で二重通知なし |
